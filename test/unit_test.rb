...
require_relative 'grid_consumption_per_day_test'
require_relative 'grid_consumption_per_month_test'
require_relative 'solar_production_per_day_test'
require_relative 'solar_watts_test'
